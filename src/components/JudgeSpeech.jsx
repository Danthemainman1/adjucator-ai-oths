                    ...
                    <div className="flex-1 rounded-sm border border-gold/20 bg-base-white shadow-lg shadow-gold/5 overflow-hidden flex flex-col min-h-[400px]">
                        ...
                        <div className="p-4 border-t border-gold/10 bg-base-cream flex justify-end items-center">
                            <button
                                ...
                                disabled={loading}
                                className="px-8 py-3 rounded-sm bg-teal text-accent-crimson font-bold uppercase tracking-widest text-xs shadow-md shadow-teal/20 hover:bg-teal-dark hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                            >
